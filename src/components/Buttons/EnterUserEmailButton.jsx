...
const EnterUserEmailButton = ({ placeholder = "Ingresa tu correo electrónico" }) => {
  ...
  const handleKeyUp = (event) => {
    if (event.key === "Enter") {
      ...
      console.log("Valor ingresado:", inputValue); // Imprime el valor en la consola
...
export default EnterUserEmailButton;